...
<template>
  <div class="container mx-auto px-4 py-8">
    ...
    <div 
      ...
      class="fixed z-50 bg-white rounded-lg shadow-xl overflow-hidden transform transition-transform"
      :style="{
    ...
    >
      ...
      >
        <h2 class="text-2xl mb-6">上传新作品</h2>
